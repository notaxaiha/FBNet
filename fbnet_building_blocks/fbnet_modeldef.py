...
MODEL_ARCH = {
    ...
    "FL_ref_30M": {
            ...
            ["ir_k3_e3"], 
            ["ir_k3_e6"], ["skip"], 
            ["ir_k5_e6"], ["skip"], ["ir_k3_s2"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["ir_k5_s2"], ["skip"], 
            ["skip"], 
                ],
                "block_cfg": {
                    "first": [32, 1],
    ...
    "cifar100_ref_30M": {
            ...
            ["ir_k3_e6"], 
            ["ir_k3_e6"], ["skip"], 
            ["ir_k5_e6"], ["ir_k3_e3"], ["ir_k3_s2"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e1"], ["ir_k5_e1"], 
    ...
    "cifar10_fbnet": {
            ...
            ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k5_e6"],
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e1"],
            ["skip"],
                ],
                "block_cfg": {
                    "first": [32, 1],
...
"FBNet_DoReFa_w2a2": {
    ...
    "cifar10_ref_30M_lambda_5e-1": {
            "block_op_type": [
            ["ir_k3_s2"], 
            ["ir_k3_e3"], ["skip"], 
            ["ir_k5_e3"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["ir_k3_s2"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["skip"], ["skip"], 
            ["ir_k5_s2"], ["skip"], ["skip"], 
            ["skip"], 
                ],
    ...
    "80M_warmup_90ep": {
        "block_op_type": [
            ["ir_k5_e3"],
            ["ir_k3_e6"], ["skip"],
            ["ir_k3_s2"], ["ir_k3_e6"], ["ir_k5_e1"],
            ["ir_k5_e3"], ["ir_k3_e6"], ["skip"], ["ir_k5_s2"],
        ...
        "block_cfg": {
            ...
            "stages": [
                [[3, 16, 1, 1]],  # stage 1
                [[6, 24, 1, 1]], [[1, 24, 1, 1]],  # stage 2
                [[1, 32, 1, 2]], [[6, 32, 1, 1]], [[1, 32, 1, 1]],  # stage 3
    ...
    "80M_warmup_10ep": {
        "block_op_type": [
            ["ir_k3_e6"],
            ["ir_k3_e6"], ["ir_k3_e1"],
            ["ir_k5_e6"], ["ir_k3_e6"], ["skip"],
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e6"],
            ["ir_k5_e6"], ["ir_k3_s2"], ["skip"],
            ["ir_k5_e6"], ["ir_k5_s2"], ["ir_k5_s2"],
            ["skip"],
        ],
        "block_cfg": {
    ...
    "30M_warmup_90/300ep": {
        "block_op_type": [
            ["ir_k3_e1"],
            ["ir_k3_e6"], ["ir_k3_e6"],
            ["ir_k5_e3"], ["ir_k5_e1"], ["ir_k3_e3"],
            ["ir_k3_s2"], ["ir_k3_e6"], ["ir_k3_s2"], ["ir_k5_e3"],
            ["skip"], ["skip"], ["skip"],
            ["skip"], ["skip"], ["ir_k5_e3"],
            ["skip"],
        ],
        "block_cfg": {
            ...
            "stages": [
                [[1, 16, 1, 1]],  # stage 1
                [[6, 24, 1, 1]], [[6, 24, 1, 1]],  # stage 2
                [[3, 32, 1, 2]], [[1, 32, 1, 1]], [[3, 32, 1, 1]],  # stage 3
                [[1, 64, 1, 2]], [[6, 64, 1, 1]], [[1, 64, 1, 1]], [[3, 64, 1, 1]],  # stage 4
                [[1, 96, 1, 1]], [[1, 96, 1, 1]], [[1, 96, 1, 1]],  # stage 5
                [[1, 160, 1, 2]], [[1, 160, 1, 1]], [[3, 160, 1, 1]],  # stage 6
                [[1, 320, 1, 1]],  # stage 7
            ],
            "backbone": [num for num in range(18)],
        },
    ...
    "30M_warmup_150ep/300ep": {
        "block_op_type": [
            ["ir_k3_s2"],
            ["ir_k3_e3"], ["skip"],
            ["skip"], ["ir_k3_s2"], ["ir_k3_e6"],
        ...
        "block_cfg": {
            ...
            "stages": [
                [[1, 16, 1, 1]],  # stage 1
                [[3, 24, 1, 1]], [[1, 24, 1, 1]],  # stage 2
                [[1, 32, 1, 2]], [[1, 32, 1, 1]], [[6, 32, 1, 1]],  # stage 3
                [[6, 64, 1, 2]], [[1, 64, 1, 1]], [[1, 64, 1, 1]], [[1, 64, 1, 1]],  # stage 4
                [[1, 96, 1, 1]], [[1, 96, 1, 1]], [[1, 96, 1, 1]],  # stage 5
                [[1, 160, 1, 2]], [[1, 160, 1, 1]], [[1, 160, 1, 1]],  # stage 6
                [[1, 320, 1, 1]],  # stage 7
