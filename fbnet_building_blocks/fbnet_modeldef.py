...
MODEL_ARCH = {
    ...
    "dw": {
            ...
            ["skip"], ["skip"], 
            ["skip"], ["skip"], ["skip"], 
            ["skip"], ["skip"], ["ir_k5_s2"], ["ir_k3_e1"], 
            ["skip"], ["skip"], ["skip"], 
            ["ir_k3_s2"], ["ir_k5_s2"], ["skip"], 
            ["skip"], 
                    ],
                    "block_cfg": {
                        "first": [32, 1],
                        "stages": [
                            [[1, 16, 1, 1]],                                                        # stage 1
                            [[1, 24, 1, 2]],  [[1, 24, 1, 1]],  # stage 2
                            [[1, 32, 1, 2]],  [[1, 32, 1, 1]],              [[1, 32, 1, 1]],  # stage 3
    ...
    "dw_10_80": {
            ...
            ["skip"], 
            ["skip"], ["skip"], 
            ["ir_k5_s2"], ["ir_k5_s2"], ["ir_k5_e1"], 
            ["ir_k3_e6"], ["ir_k5_e1"], ["skip"], ["skip"], 
            ["skip"], ["skip"], ["skip"], 
            ["skip"], ["ir_k3_s2"], ["ir_k5_s2"], 
            ["skip"], 
                    ],
                    "block_cfg": {
                        "first": [32, 1],
    ...
    "dw_10_200": {
            ...
            ["skip"], 
            ["ir_k3_e6"], ["skip"], 
            ["ir_k5_s2"], ["skip"], ["ir_k3_s2"], 
            ["ir_k3_s2"], ["ir_k5_s2"], ["ir_k5_e1"], ["skip"], 
            ["skip"], ["ir_k5_e1"], ["skip"], 
            ["skip"], ["ir_k3_s2"], ["ir_k5_e1"], 
            ["skip"], 
                    ],
                    "block_cfg": {
                        "first": [32, 1],
