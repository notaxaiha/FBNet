...
MODEL_ARCH = {
    ...
    "ttest2": {
            ...
            ["ir_k3_s2"], 
            ["skip"], ["ir_k5_e1"], 
            ["ir_k3_e6"], ["ir_k5_e1"], ["ir_k3_e3"], 
            ["ir_k3_e6"], ["ir_k3_e3"], ["ir_k3_s2"], ["ir_k3_s2"], 
            ["ir_k3_s2"], ["ir_k3_e6"], ["ir_k3_s2"], 
            ["ir_k3_e3"], ["ir_k5_s2"], ["ir_k5_e6"], 
            ["ir_k3_e1"], 
                ],
                "block_cfg": {
                    "first": [32, 1],
                    "stages": [
                        ...
                        [[3, 160, 1, 2]], [[1, 160, 1, 1]],         [[6, 160, 1, 1]], # stage 6
                        [[1, 320, 1, 1]],                                                       # stage 7
                    ],
                    "backbone": [num for num in range(18)],
                },
    ...
    "wook_test1": {
            ...
            ["ir_k5_e6"], 
            ["ir_k3_e1"], ["ir_k5_s2"], 
            ["ir_k3_e1"], ["ir_k5_e1"], ["ir_k3_s2"], 
            ["ir_k5_s2"], ["ir_k3_e6"], ["ir_k5_s2"], ["ir_k5_e1"], 
            ["ir_k5_e3"], ["ir_k3_e6"], ["ir_k5_e6"], 
            ["ir_k3_s2"], ["ir_k5_e3"], ["ir_k5_e6"], 
            ["ir_k5_e1"], 
                ],
                "block_cfg": {
                    "first": [32, 1],
                    "stages": [
                        ...
                        [[1, 64, 1, 2]],  [[6, 64, 1, 1]],          [[1, 64, 1, 1]],  [[1, 64, 1, 1]],  # stage 4
                        [[3, 96, 1, 1]], [[6, 96, 1, 1]],         [[6, 96, 1, 1]], # stage 5
                        [[1, 160, 1, 2]], [[3, 160, 1, 1]],         [[6, 160, 1, 1]], # stage 6
                        [[1, 320, 1, 1]],                                                       # stage 7
                    ],
                    "backbone": [num for num in range(18)],
                },
