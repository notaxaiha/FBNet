...
MODEL_ARCH = {
    ...
    "mb_cos_flop_oh": {
            ...
            ["ir_k3_e6"], ["skip"], 
            ["ir_k5_e6"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["ir_k5_e3"], ["ir_k5_e1"], ["ir_k5_e3"], 
            ["ir_k5_e6"], ["ir_k5_e1"], ["ir_k5_e1"], 
            ["ir_k5_e6"], ["ir_k5_e1"], ["ir_k5_s2"], 
            ["skip"], 
                    ],
                    "block_cfg": {
                        "first": [32, 1],
                        "stages": [
                            [[1, 16, 1, 1]],                                                        # stage 1
                            [[6, 24, 1, 2]],  [[1, 24, 1, 1]],  # stage 2
                            [[6, 32, 1, 2]],  [[1, 32, 1, 1]],              [[1, 32, 1, 1]],  # stage 3
                            [[6, 64, 1, 2]],  [[3, 64, 1, 1]],              [[1, 64, 1, 1]],  [[3, 64, 1, 1]],  # stage 4
                            [[6, 96, 1, 1]], [[1, 96, 1, 1]],             [[1, 96, 1, 1]], # stage 5
                            [[6, 160, 1, 2]], [[1, 160, 1, 1]],             [[1, 160, 1, 1]], # stage 6
                            [[1, 320, 1, 1]],                                                       # stage 7
    ...
    "mb_exp_flop_oh": {
            ...
            ["skip"], 
            ["skip"], ["ir_k3_s2"], 
            ["ir_k5_e6"], ["skip"], ["ir_k5_s2"], 
            ["ir_k5_e6"], ["skip"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["ir_k5_s2"], ["ir_k5_s2"], 
            ["skip"], 
                    ],
                    "block_cfg": {
                        "first": [32, 1],
    ...
    "mb_exp_noflop_ws": {
            ...
            ["ir_k3_e6"], 
            ["ir_k3_e6"], ["ir_k3_e6"], 
            ["ir_k5_e6"], ["skip"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k5_e3"], ["ir_k5_e6"], 
            ["skip"], 
                    ],
                    "block_cfg": {
                        "first": [32, 1],
                        "stages": [
                            ...
                            [[6, 32, 1, 2]],  [[1, 32, 1, 1]],              [[6, 32, 1, 1]],  # stage 3
                            [[6, 64, 1, 2]],  [[6, 64, 1, 1]],              [[6, 64, 1, 1]],  [[6, 64, 1, 1]],  # stage 4
                            [[6, 96, 1, 1]], [[6, 96, 1, 1]],             [[6, 96, 1, 1]], # stage 5
                            [[6, 160, 1, 2]], [[3, 160, 1, 1]],             [[6, 160, 1, 1]], # stage 6
                            [[1, 320, 1, 1]],                                                       # stage 7
                        ],
                        "backbone": [num for num in range(18)],
                    },
    ...
    "0819_orig_gumbel_N_1000_reg_1e_5_sampling": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k3_e6"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k3_s2"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k3_e6"], 
            ["ir_k5_e6"], ["ir_k5_e3"], ["ir_k3_e1"], 
            ["ir_k5_e6"], ["ir_k5_s2"], ["ir_k3_e1"], 
            ["skip"], 
                ],
                "block_cfg": {
                    "first": [32, 1],
                    "stages": [
                        [[6, 16, 1, 1]],                                                        # stage 1
                        [[6, 24, 1, 1]],  [[6, 24, 1, 1]],  # stage 2
                        [[6, 32, 1, 2]],  [[6, 32, 1, 1]],          [[1, 32, 1, 1]],  # stage 3
                        [[6, 64, 1, 2]],  [[6, 64, 1, 1]],          [[6, 64, 1, 1]],  [[6, 64, 1, 1]],  # stage 4
                        [[6, 96, 1, 1]], [[3, 96, 1, 1]],         [[1, 96, 1, 1]], # stage 5
                        [[6, 160, 1, 2]], [[1, 160, 1, 1]],         [[1, 160, 1, 1]], # stage 6
                        [[1, 320, 1, 1]],                                                       # stage 7
                    ],
                    "backbone": [num for num in range(18)],
    ...
    "0819_orig_gumbel_N_500_reg_1e_4_sampling": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k3_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k3_e3"], 
            ["ir_k3_e6"], ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k5_e3"], ["ir_k5_e3"], 
            ["ir_k5_e6"], ["ir_k5_e1"], ["ir_k3_e1"], 
            ["skip"], 
                ],
                "block_cfg": {
                    "first": [32, 1],
                    "stages": [
                        [[6, 16, 1, 1]],                                                        # stage 1
                        [[6, 24, 1, 1]],  [[6, 24, 1, 1]],  # stage 2
                        [[6, 32, 1, 2]],  [[6, 32, 1, 1]],          [[3, 32, 1, 1]],  # stage 3
                        [[6, 64, 1, 2]],  [[6, 64, 1, 1]],          [[6, 64, 1, 1]],  [[6, 64, 1, 1]],  # stage 4
                        [[6, 96, 1, 1]], [[3, 96, 1, 1]],         [[3, 96, 1, 1]], # stage 5
                        [[6, 160, 1, 2]], [[1, 160, 1, 1]],         [[1, 160, 1, 1]], # stage 6
                        [[1, 320, 1, 1]],                                                       # stage 7
    ...
    "0819_orig_gumbel_N_500_reg_1e_5_sampling": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k3_e6"], ["ir_k5_s2"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e3"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k3_e1"], ["ir_k5_e3"], 
            ["ir_k5_e6"], ["ir_k5_e1"], ["ir_k5_s2"], 
            ["skip"], 
                ],
                "block_cfg": {
                    ...
                    "stages": [
                        ...
                        [[6, 32, 1, 2]],  [[6, 32, 1, 1]],          [[3, 32, 1, 1]],  # stage 3
                        [[6, 64, 1, 2]],  [[6, 64, 1, 1]],          [[6, 64, 1, 1]],  [[6, 64, 1, 1]],  # stage 4
                        [[6, 96, 1, 1]], [[1, 96, 1, 1]],         [[3, 96, 1, 1]], # stage 5
                        [[6, 160, 1, 2]], [[1, 160, 1, 1]],         [[1, 160, 1, 1]], # stage 6
                        [[1, 320, 1, 1]],                                                       # stage 7
                    ],
                    "backbone": [num for num in range(18)],
    ...
    "0819_orig_gumbel_N_1000_reg_1e_4_sampling": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k3_e6"], ["ir_k5_e1"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k3_e3"], 
            ["ir_k3_e6"], ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k3_e6"], 
            ["ir_k5_e6"], ["ir_k5_e3"], ["ir_k5_s2"], 
            ["ir_k5_e6"], ["ir_k5_e1"], ["ir_k3_e6"], 
            ["skip"], 
                ],
                "block_cfg": {
                    "first": [32, 1],
                    "stages": [
                        ...
                        [[6, 64, 1, 2]],  [[6, 64, 1, 1]],          [[6, 64, 1, 1]],  [[6, 64, 1, 1]],  # stage 4
                        [[6, 96, 1, 1]], [[3, 96, 1, 1]],         [[1, 96, 1, 1]], # stage 5
                        [[6, 160, 1, 2]], [[1, 160, 1, 1]],         [[6, 160, 1, 1]], # stage 6
                        [[1, 320, 1, 1]],                                                       # stage 7
                    ],
                    "backbone": [num for num in range(18)],
                },
            },
    "0819_orig_gumbel_N_500_reg_1e_4": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k3_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k3_e3"], 
    ...
    "0819_orig_gumbel_N_1000_reg_1e_5": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k3_e6"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k3_s2"], 
    ...
    "0819_orig_gumbel_N_1000_reg_1e_4": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k3_e6"], ["ir_k5_e1"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k3_e3"], 
    ...
    "0819_orig_gumbel_N_500_reg_1e_5": {
            "block_op_type": [
            ["ir_k5_e6"], 
            ["ir_k3_e6"], ["ir_k5_s2"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e3"], 
